...
- **Global scope**: `/Users/shaa/Desktop/Senior Project/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/shaa/Desktop/Senior Project/.codex/notes/`)
...
2. Glob `/Users/shaa/Desktop/Senior Project/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/shaa/Desktop/Senior Project/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/shaa/Desktop/Senior Project/.codex/notes/` — works in any directory
